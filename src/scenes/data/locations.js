...
*/
	...
	var path = "./locations/";
module.exports = [
	require(path+'dorm.js'),
	require(path+'howe.js'),
	require(path+'ucc.js'),
	require(path+'babbio.js'),
	require(path+'palmer_lawn.js'),
	require(path+'gym.js'),
	require(path+'stevens_park.js'),
	require(path+'pier_a.js'),
	require(path+'pier_water.js'),
	require(path+'path_station.js'),
	require(path+'clock.js'),
	require(path+'gios.js'),
	require(path+'gateway.js'),
	require(path+'road.js'),
	require(path+'mclean.js'),
	require(path+'library.js'),
